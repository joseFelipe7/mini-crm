...
async function listCollaborator(page = 1){
   ...
   let request = await fetch(`http://localhost/login/api/product?page=${page}&filter[search]=${searchCollaborator.value}`,{
      method:"GET",
      headers:{
